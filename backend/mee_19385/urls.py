...
admin.site.site_header = "mee"
admin.site.site_title = "mee Admin Portal"
admin.site.index_title = "mee Admin"

# swagger
api_info = openapi.Info(
    title="mee API", default_version="v1", description="API documentation for mee App",
)
